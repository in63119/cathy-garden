...
export interface GardenProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "adminTransfer"
      | "getAdmin"
  ...
  getEvent(
    nameOrSignatureOrTopic: "AdminTransferred" | "Upgraded"
  ): EventFragment;
...
export interface GardenProxy extends BaseContract {
  connect(runner?: ContractRunner | null): GardenProxy;
  waitForDeployment(): Promise<this>;

  interface: GardenProxyInterface;
